...
public class TestSemana2Consigna06 {
	...
	@Test
	public void test06CellAbsorbiendoVidaIncrementaVidaPropiaYdisminuyeLaDelOponenteEnIgualCantidad() throws ErrorNoCumpleReqTrans, ErrorNoHayMasTrans, ErrorPosicionInvalida, ErrorUnidadNoEsEnemiga, ErrorKiInsuficiente, ErrorEnemigoFueraDeAlcance {
		...
		assertEquals(goku.getPorcentajeVida(),96);//96%
		assertEquals(cell.getPorcentajeVida(),100);//100%
